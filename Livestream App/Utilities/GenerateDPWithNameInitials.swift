//
//  GenerateDPWithNameInitials.swift
//  Livestream App
//
//  Created by unthinkable-mac-0025 on 24/08/21.
//  Copyright © 2021 Daffodil Software Pvt. Ltd. All rights reserved.
//


/*
 NOTE:- Change the font size to adjust the Font size of the taxt in the DPImage. Its used to set the varible "attributes"
 */
import UIKit
